...
<h1 style="text-align:center">Previous Winnings <span style="font-size: 1.5rem;">{{date("F j, Y", strtotime("yesterday"))}} </span></h1>
...
<td colspan="7">
 <h5> <span class="float-left" >
    <a class=" btn btn-primary pull-right" href="/">Today Tips</a>
  </span>
  
  <span class="" >
    <a class=" btn btn-primary " href="/top"> Top Tips</a>
  </span>
