...
<h1>Post Tips</h1>
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    ...
    {{Form::text('league','',['class' => 'form-control'])}}
  </div>
  <div class="form-group">
    {{Form::label('team1','Home Team')}}
    {{Form::text('team1','',['class' => 'form-control'])}}
  </div>

  <div class="form-group">
    {{Form::label('team2','Away Team')}}
    {{Form::text('team2','',['class' => 'form-control'])}}
  </div>
  ...
  <div class="form-group">
      {{Form::label('odd','Odd')}}
      {{Form::text('odd','',['class' => 'form-control'])}}
  </div>
  ...
  <div class="form-group">
      ...
      {{Form::text('results','Not played',['class' => 'form-control'])}}
  </div>
